...
function About() {
    return (
        <div className="general">
            ...
            <h2>Cratable (beta)</h2>
            <p>Not all could afford a robust environment to make dreams to live, so <a href="/">Cratable (beta)</a> focuses on the final output of a future website. This is a beta version where the content is only viewable. Do not forget to leave a feedback so that, we could think ahead what really you want from us. Please fill in the feedback with meaningful information and don't try to spam it 🙏🏼.</p>
